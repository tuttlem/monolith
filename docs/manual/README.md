...
33. [Arch User-Syscall Invoke Facade](core/user-syscall-invoke.md)
34. [Input Substrate and Arch Hooks](core/input-substrate.md)
35. [User-Mode Substrate Scope](core/user-mode-substrate.md)
36. [Generic User Task Bootstrap](core/user-task-bootstrap.md)
37. [User Memory Access (`uaccess`)](core/uaccess.md)
38. [Core Boot Sequence](core/boot-sequence.md)
39. [Boot ABI (`boot_info_t`)](core/boot-info-abi.md)
40. [Core API Reference](core/api-reference.md)
41. [Core Data Structures and Enums](core/data-structures.md)
42. [Architecture Divergence Guide](core/architecture-divergence.md)
43. [Implementation Coverage](core/implementation-coverage.md)
44. [API Cheatsheet](core/api-cheatsheet.md)
