...
14. [Core Boot Sequence](core/boot-sequence.md)
15. [Boot ABI (`boot_info_t`)](core/boot-info-abi.md)
16. [Core API Reference](core/api-reference.md)
17. [Core Data Structures and Enums](core/data-structures.md)
18. [Architecture Divergence Guide](core/architecture-divergence.md)
19. [Implementation Coverage](core/implementation-coverage.md)
20. [API Cheatsheet](core/api-cheatsheet.md)
