...
16. [Per-CPU Runtime](core/percpu.md)
17. [SMP Bootstrap Skeleton](core/smp-bootstrap.md)
18. [Unified Device Discovery](core/device-discovery.md)
19. [Device Model Baseline](core/device-model.md)
20. [Device Bus Core](core/device-bus.md)
21. [Hardware Resource Manager](core/hardware-resources.md)
22. [PCI Enumeration](core/pci-enumeration.md)
23. [USB Enumeration Skeleton](core/usb-enumeration.md)
24. [Device Domain Baseline](core/device-domains.md)
25. [Device Reporting and Introspection](core/device-reporting.md)
26. [Capability Profiles and Feature Gating](core/capability-profiles.md)
27. [Network Baseline (Optional Domain)](core/network-baseline.md)
28. [Audio Baseline (Optional Domain)](core/audio-baseline.md)
29. [Standard Capability Domains](core/standard-capability-domains.md)
30. [Syscall Transport ABI](core/syscall-transport.md)
31. [Core Boot Sequence](core/boot-sequence.md)
32. [Boot ABI (`boot_info_t`)](core/boot-info-abi.md)
33. [Core API Reference](core/api-reference.md)
34. [Core Data Structures and Enums](core/data-structures.md)
35. [Architecture Divergence Guide](core/architecture-divergence.md)
36. [Implementation Coverage](core/implementation-coverage.md)
37. [API Cheatsheet](core/api-cheatsheet.md)
