...
static inline void driver_ring_init(driver_ring_t *ring, u64 capacity) {
...
static inline u64 driver_ring_count(const driver_ring_t *ring) {
...
static inline int driver_ring_push(driver_ring_t *ring, u64 *out_slot) {
  u64 next_tail;
...
static inline int driver_ring_pop(driver_ring_t *ring, u64 *out_slot) {
