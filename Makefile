...
$(BUILD_X64)/BOOTX64.EFI: $(BUILD_X64)/boot/efi_main.o $(BUILD_X64)/kernel/kmain.o $(BUILD_X64)/kernel/print.o $(BUILD_X64)/kernel/status.o $(BUILD_X64)/kernel/percpu.o $(BUILD_X64)/kernel/smp.o $(BUILD_X64)/kernel/discovery/hw_discovery.o $(BUILD_X64)/kernel/discovery/acpi_parser.o $(BUILD_X64)/kernel/discovery/dtb_parser.o $(BUILD_X64)/kernel/panic.o $(BUILD_X64)/kernel/timebase.o $(BUILD_X64)/kernel/irq_controller.o $(BUILD_X64)/kernel/device_model.o $(BUILD_X64)/kernel/device_bus.o $(BUILD_X64)/kernel/pci.o $(BUILD_X64)/kernel/usb.o $(BUILD_X64)/kernel/interrupts.o $(BUILD_X64)/kernel/timer.o $(BUILD_X64)/kernel/diag/boot_info.o $(BUILD_X64)/kernel/mm/page_alloc.o $(BUILD_X64)/kernel/mm/kmalloc.o $(BUILD_X64)/kernel/mm/mmu.o $(BUILD_X64)/arch/x86_64/cpu/cpu.o $(BUILD_X64)/arch/x86_64/cpu/smp.o $(BUILD_X64)/arch/x86_64/mm/memory_init.o $(BUILD_X64)/arch/x86_64/mm/early_paging.o $(BUILD_X64)/arch/x86_64/mm/mmu_backend.o $(BUILD_X64)/arch/x86_64/irq/interrupts.o $(BUILD_X64)/arch/x86_64/irq/pic.o $(BUILD_X64)/arch/x86_64/timer/timer.o
	@mkdir -p $(@D)
...
$(BUILD_A64)/BOOTAA64.EFI: $(BUILD_A64)/boot/efi_main.o $(BUILD_A64)/kernel/kmain.o $(BUILD_A64)/kernel/print.o $(BUILD_A64)/kernel/status.o $(BUILD_A64)/kernel/percpu.o $(BUILD_A64)/kernel/smp.o $(BUILD_A64)/kernel/discovery/hw_discovery.o $(BUILD_A64)/kernel/discovery/acpi_parser.o $(BUILD_A64)/kernel/discovery/dtb_parser.o $(BUILD_A64)/kernel/panic.o $(BUILD_A64)/kernel/timebase.o $(BUILD_A64)/kernel/irq_controller.o $(BUILD_A64)/kernel/device_model.o $(BUILD_A64)/kernel/device_bus.o $(BUILD_A64)/kernel/pci.o $(BUILD_A64)/kernel/usb.o $(BUILD_A64)/kernel/interrupts.o $(BUILD_A64)/kernel/timer.o $(BUILD_A64)/kernel/diag/boot_info.o $(BUILD_A64)/kernel/mm/page_alloc.o $(BUILD_A64)/kernel/mm/kmalloc.o $(BUILD_A64)/kernel/mm/mmu.o $(BUILD_A64)/arch/arm64/cpu/cpu.o $(BUILD_A64)/arch/arm64/cpu/smp.o $(BUILD_A64)/arch/arm64/mm/memory_init.o $(BUILD_A64)/arch/arm64/mm/early_paging.o $(BUILD_A64)/arch/arm64/mm/mmu_backend.o $(BUILD_A64)/arch/arm64/irq/interrupts.o $(BUILD_A64)/arch/arm64/irq/gicv2.o $(BUILD_A64)/arch/arm64/irq/entry.o $(BUILD_A64)/arch/arm64/timer/timer.o
	@mkdir -p $(@D)
	@command -v $(LLD_LINK) >/dev/null 2>&1 || { echo "error: $(LLD_LINK) not found. Install lld."; exit 1; }
